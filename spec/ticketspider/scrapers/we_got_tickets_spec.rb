...
describe Ticketspider::Scrapers::WeGotTickets do
  
  let :scraper do
    Ticketspider::Scrapers::WeGotTickets.new(start_url)
  end
  
  let :scraper_with_spider do
    Ticketspider::Scrapers::WeGotTickets.new(start_url, spider)
  end
  
  let :spider do 
    Ticketspider::Spiders::WeGotTickets.new
  end
